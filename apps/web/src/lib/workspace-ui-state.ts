...
const STORAGE_KEYS = {
  desktopSplitPct: 'papersearchagent.workspace.desktop_split_pct',
  mobilePane: 'papersearchagent.workspace.mobile_pane',
  rationaleOpen: 'papersearchagent.workspace.rationale_open',
} as const;
