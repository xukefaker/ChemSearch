...
def main() -> None:
    ...
    parser.add_argument(
        "--benchmark-jsonl",
        default="/workspace/ChemSearch/data/benchmarks/chemqa40/ablation/input/chemqa40_search_benchmark_final.jsonl",
    )
    parser.add_argument(
        "--parsed-root",
        default="/workspace/ChemSearch/data/parsed/mineru",
    )
    parser.add_argument(
        "--out-root",
        default="/workspace/ChemSearch/data/benchmarks/chemqa40/baseline_inputs",
    )
