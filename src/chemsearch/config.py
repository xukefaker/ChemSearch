...
class Settings:
    ...
    def from_env(
        ...
        *,
        ...
        device = _as_optional_str(_env_value("CHEMSEARCH_DEVICE"))
        data_dir_override = _env_value("CHEMSEARCH_DATA_DIR")
        data_dir = _resolve_dir(
            base_dir,
            _env_or_config(
                env_name="CHEMSEARCH_DATA_DIR",
        ...
        mineru_output_dir = _resolve_dir(
            base_dir,
            _env_value("CHEMSEARCH_MINERU_OUTPUT_DIR")
            or (
                str(data_dir / "parsed" / "mineru")
                if data_dir_override is not None
                else _env_or_config(
                    env_name="CHEMSEARCH_MINERU_OUTPUT_DIR",
                    payload=config_payload,
        ...
        settings = cls(
            ...
            public_api_base_url=_as_optional_str(
                _env_or_config(
                    env_name="CHEMSEARCH_PUBLIC_API_BASE_URL",
                    payload=config_payload,
            ...
            pdf_parser_backend=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_PDF_PARSER_BACKEND",
                    payload=config_payload,
            ...
            mineru_command=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_COMMAND",
                    payload=config_payload,
                    path=("mineru", "command"),
                )
            ),
            mineru_backend=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_BACKEND",
                    payload=config_payload,
                    path=("mineru", "backend"),
                )
            ),
            mineru_method=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_METHOD",
                    payload=config_payload,
                    path=("mineru", "method"),
                )
            ),
            mineru_lang=_as_optional_str(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_LANG",
                    payload=config_payload,
                    path=("mineru", "lang"),
                )
            ),
            mineru_source=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_SOURCE",
                    payload=config_payload,
                    path=("mineru", "source"),
                )
            ),
            mineru_device=_as_optional_str(
                _env_value("CHEMSEARCH_MINERU_DEVICE")
                or device
                or _env_or_config(
                    env_name="CHEMSEARCH_MINERU_DEVICE",
                    payload=config_payload,
                    path=("mineru", "device"),
                )
            ),
            mineru_formula=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_FORMULA",
                    payload=config_payload,
                    path=("mineru", "formula"),
                )
            ),
            mineru_table=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_TABLE",
                    payload=config_payload,
                    path=("mineru", "table"),
                )
            ),
            ...
            mineru_require_middle_json=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_REQUIRE_MIDDLE_JSON",
                    payload=config_payload,
            ...
            mineru_require_markdown=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_REQUIRE_MARKDOWN",
                    payload=config_payload,
            ...
            mineru_timeout_seconds=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_MINERU_TIMEOUT_SECONDS",
                    payload=config_payload,
            ...
            openai_enabled=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_OPENAI_ENABLED",
                    payload=config_payload,
                    path=("openai", "enabled"),
                )
            ),
            grobid_enabled=_as_bool(
                _env_or_config(
                    env_name="CHEMSEARCH_GROBID_ENABLED",
                    payload=config_payload,
                    path=("grobid", "enabled"),
                )
            ),
            grobid_base_url=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_GROBID_BASE_URL",
                    payload=config_payload,
            ...
            grobid_timeout_seconds=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_GROBID_TIMEOUT_SECONDS",
                    payload=config_payload,
            ...
            paper_dense_model=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_PAPER_DENSE_MODEL",
                    payload=config_payload,
            ...
            chunk_dense_model=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_CHUNK_DENSE_MODEL",
                    payload=config_payload,
            ...
            chunk_target_tokens=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_CHUNK_TARGET_TOKENS",
                    payload=config_payload,
            ...
            chunk_overlap_tokens=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_CHUNK_OVERLAP_TOKENS",
                    payload=config_payload,
            ...
            candidate_pool_size=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_CANDIDATE_POOL_SIZE",
                    payload=config_payload,
            ...
            verifier_candidate_limit=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_VERIFIER_CANDIDATE_LIMIT",
                    payload=config_payload,
            ...
            candidate_source_limit=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_CANDIDATE_SOURCE_LIMIT",
                    payload=config_payload,
            ...
            default_top_k=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEFAULT_TOP_K",
                    payload=config_payload,
            ...
            paper_sparse_rrf_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_PAPER_SPARSE_RRF_WEIGHT",
                    payload=config_payload,
            ...
            paper_dense_rrf_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_PAPER_DENSE_RRF_WEIGHT",
                    payload=config_payload,
            ...
            chunk_aggregated_rrf_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_CHUNK_AGGREGATED_RRF_WEIGHT",
                    payload=config_payload,
            ...
            literal_entity_rrf_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_LITERAL_ENTITY_RRF_WEIGHT",
                    payload=config_payload,
            ...
            exact_phrase_rrf_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_EXACT_PHRASE_RRF_WEIGHT",
                    payload=config_payload,
            ...
            aspect_coverage_bonus=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_ASPECT_COVERAGE_BONUS",
                    payload=config_payload,
            ...
            source_diversity_bonus=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_SOURCE_DIVERSITY_BONUS",
                    payload=config_payload,
            ...
            literal_entity_bonus=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_LITERAL_ENTITY_BONUS",
                    payload=config_payload,
            ...
            exact_phrase_bonus=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_EXACT_PHRASE_BONUS",
                    payload=config_payload,
            ...
            evidence_sparse_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_EVIDENCE_SPARSE_WEIGHT",
                    payload=config_payload,
            ...
            evidence_dense_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_EVIDENCE_DENSE_WEIGHT",
                    payload=config_payload,
            ...
            evidence_reranker_weight=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_EVIDENCE_RERANKER_WEIGHT",
                    payload=config_payload,
            ...
            evidence_reranker_candidate_chunks=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_EVIDENCE_RERANKER_CANDIDATE_CHUNKS",
                    payload=config_payload,
            ...
            verifier_max_workers=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_VERIFIER_MAX_WORKERS",
                    payload=config_payload,
            ...
            evidence_chunk_text_limit=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_EVIDENCE_CHUNK_TEXT_LIMIT",
                    payload=config_payload,
            ...
            reranker_model=_as_str(
                _env_or_config(
                    env_name="CHEMSEARCH_RERANKER_MODEL",
                    payload=config_payload,
                    path=("reranker", "model"),
                )
            ),
            reranker_device=_as_optional_str(
                _env_value("CHEMSEARCH_RERANKER_DEVICE")
                or device
                or _env_or_config(
                    env_name="CHEMSEARCH_RERANKER_DEVICE",
                    payload=config_payload,
            ...
            reranker_batch_size=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_RERANKER_BATCH_SIZE",
                    payload=config_payload,
            ...
            deep_chat_history_turn_limit=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEEP_CHAT_HISTORY_TURN_LIMIT",
                    payload=config_payload,
            ...
            deep_chat_global_evidence_k=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEEP_CHAT_GLOBAL_EVIDENCE_K",
                    payload=config_payload,
            ...
            deep_chat_local_evidence_k=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEEP_CHAT_LOCAL_EVIDENCE_K",
                    payload=config_payload,
            ...
            deep_chat_retrieval_candidate_k=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEEP_CHAT_RETRIEVAL_CANDIDATE_K",
                    payload=config_payload,
            ...
            deep_chat_max_evidence_text_chars=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DEEP_CHAT_MAX_EVIDENCE_TEXT_CHARS",
                    payload=config_payload,
            ...
            request_timeout=_as_float(
                _env_or_config(
                    env_name="CHEMSEARCH_REQUEST_TIMEOUT",
                    payload=config_payload,
                    path=("openai", "request_timeout"),
                )
            ),
            dense_device=_as_optional_str(
                _env_value("CHEMSEARCH_DENSE_DEVICE")
                or device
                or _env_or_config(
                    env_name="CHEMSEARCH_DENSE_DEVICE",
                    payload=config_payload,
            ...
            dense_batch_size=_as_int(
                _env_or_config(
                    env_name="CHEMSEARCH_DENSE_BATCH_SIZE",
                    payload=config_payload,
            ...
            input_price_per_1m=_as_optional_float(
                _env_or_config(
                    env_name="CHEMSEARCH_INPUT_PRICE_PER_1M",
                    payload=config_payload,
            ...
            output_price_per_1m=_as_optional_float(
                _env_or_config(
                    env_name="CHEMSEARCH_OUTPUT_PRICE_PER_1M",
                    payload=config_payload,
...
def _resolve_corpus(*, base_dir: Path, data_dir: Path, explicit: CorpusSpec | None) -> CorpusSpec:
    ...
    env_venue = _env_value("CHEMSEARCH_VENUE")
    env_year = _env_value("CHEMSEARCH_YEAR")
    env_track = _env_value("CHEMSEARCH_TRACK")
